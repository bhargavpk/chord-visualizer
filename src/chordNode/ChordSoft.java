...
public class ChordSoft {
	...
	public static void main(String[] args)
	{
		...
		try 
		{
			int nodeId1 = node1.create(20);
			int nodeId2 = node2.create(15);
			int nodeId3 = node3.create(5);
...
//			firstNode.simulate(nodeId2, nodeId3);
//			secondNode.simulate(nodeId3, nodeId1);
//			thirdNode.simulate(nodeId1, nodeId2);
...
//			Thread.sleep(1000);
	...
	//			NodeAbstract skeleton = (NodeAbstract)register.lookup(str1);
				...
				System.out.println("Expected successor " + firstNode.getFingerTable()[0]);
	...
	//			skeleton = (NodeAbstract)register.lookup(str2);
				...
				System.out.println("Expected successor: " + secondNode.getFingerTable()[0]);
	...
	//			skeleton = (NodeAbstract)register.lookup(str3);
				...
				System.out.println("Expected successor " + thirdNode.getFingerTable()[0]);
...
//			skeleton = (NodeAbstract)register.lookup(str3);
			...
			System.out.println("Expected successor: " + fourthNode.getFingerTable()[0]);
